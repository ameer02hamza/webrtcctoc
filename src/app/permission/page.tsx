"use client"
import { localMediaStream } from '@/helpers/callroom';
...
function Permission() {
    ...
    return (
        <div className='grid grid-col-1 items-center justify-center h-screen bg-green-500'>
            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <video ref={localVideoRef} className="rounded-t-lg"
                ...
                <div className="p-5">
                    <div className='relative rounded-md md:w-full flex justify-center gap-10'>
                    ...
                    <a href="#" className="relative -right-[70%] inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Join Now
        ...
        //             src="https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4" autoPlay loop muted></video>
        //     </div>
        //     <div className='flex flex-col bg-blue-800 gap-10'>
